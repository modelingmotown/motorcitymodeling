...
make_ecf_dummies <- function(data) {
  ...
  ecf_map <- list(
    ecf5r501 = c("5r501"), ecf5r502 = c("5r502"), ecf5r503 = c("5r503"),
    ecf5r504 = c("5r504"), ecf5r505_506_516 = c("5r505", "5r506", "5r516"),
    ecf5r508_509 = c("5r508", "5r509"), ecf5r510 = c("5r510"),
    ecf5r511_518 = c("5r511", "5r518"), ecf5r512_513 = c("5r512", "5r513"),
    ecf5r514 = c("5r514"), ecf5r517_521 = c("5r517", "5r521"),
    ecf5r523 = c("5r523"), ecf5r524 = c("5r524"), ecf5r528 = c("5r528"), ecf5r529 = c("5r529"),
    ecf5r530_532_535 = c("5r530", "5r532", "5r535"),
    ecf5r531_537 = c("5r531", "5r537"), ecf5r533 = c("5r533"),
    ecf5r534 = c("5r534"), ecf5r536 = c("5r536"), ecf5r538 = c("5r538"), ecf5r539 = c("5r539")
  )
...
make_time_adjusted_df <- function(df, mod, formula, p_out = 0.10, verbose = TRUE) {
  ...
  rate2_initial <- unname(ifelse(is.na(time_coefs["months_10to16"]), 0, time_coefs["months_10to16"]))
  rate3_initial <- unname(ifelse(is.na(time_coefs["months_17to24"]), 0, time_coefs["months_17to24"]))
...
make_metrics_kable <- function(
  ...
  r_out <- r_df %>%
    dplyr::mutate(!!source_col := r_label) %>% dplyr::relocate(dplyr::all_of(source_col))
  ...
  kb <- knitr::kable(
    display_df, caption = caption, digits = digits, format = format_type,
    booktabs = latex, escape = FALSE
  )
  kb <- kb %>%
